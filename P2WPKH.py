...
with open(filename) as f :
    add = f.read().split()
add = set(add)
print('[*]All Address TYPE P2wPKH Start With bc1 import Now...' , timer() , '\n')
...
def seek(r) :
    ...
    while True :
        ...
        if addr in add :
            ...
            f.close()
            print('Information File Name ========> p2wpkhWinerWalletDetails.txt [OK]')
            continue
# bc1q6d2w9h8wen0ksx522hqk9c6h5ne67f8qh9cx0z
